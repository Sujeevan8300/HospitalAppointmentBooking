...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2023 at 06:32 PM
...
CREATE TABLE `bookings` (
  ...
  `message` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
INSERT INTO `bookings` (`id`, `name`, `email`, `phone`, `service`, `date`, `time`, `message`, `branch`) VALUES
(1, 'V.Gobiraj', 'Gobi@gmail.com', '0771233388', 'Laboratory Service', '2023-07-08', '10:20:00.000000', 'X-Ray report', NULL),
(2, 'kamal', 'kamal@gmail.com', '0771233300', 'Laboratory Service', '2023-07-09', '10:15:40.410000', 'X ray', 'Jaffna');
...
('Sujeevan', 'sujeevan@gmail.com', 'How much do you charge for teeth cleaning?'),
('Mirojan', 'miro2626@gmail.com', 'When can i take my x-ray report?');
...
(3, 1, 'Dr.V.Sivansuthan', 'Doctor', '0771233388'),
(4, 2, 'V. Gobiraj', 'Doctor', '0765556666'),
(8, 3, 'Tharsikan', 'Doctor', '0776588991');
